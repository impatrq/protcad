...
AREA ELECTRONICA (PROGRAMACION)

linea de codigo usada y probada (funciona) 
...
#define SDA_GPIO  4
#define SCL_GPIO  5 
#define LED_PIN_X 14 // Led rojo - Eje XW
#define LED_PIN_Y 15 // Led verde - Eje Y
#define LED_PIN_VALVE 13 // Valvula de agua
#define X_LIMIT 30.20 // Límite de inclinación para el eje X
#define Y_LIMIT 30.20 // Límite de inclinación para el eje Y
...
{  
    ...
    while (true) {
        ...
        // Controlar la válvula: se abre si cualquier LED está encendido
        if (led_x_on || led_y_on) {
            gpio_put(LED_PIN_VALVE, 1);  // Abrir la válvula
        } else {
            gpio_put(LED_PIN_VALVE, 0);  // Cerrar la válvula
        }
